...
#
# DISABLED: These matchers detect client architecture from DHCP Option 93,
# but Raspberry Pi 4 doesn't send this option, making matchers useless.
#
# For multi-architecture PXE boot, use static leases with specific boot files
# or set network-level boot-file-name for a single default architecture.
